...
namespace Octane_ViewModel
{
    ...
    {
        void disconnectAsyncDoWork(object sender, DoWorkEventArgs e)
        {
        ...
        void disconnectAsyncRunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            _log(LogLevel.Verbose, "'{0}' DisconnectAsync completed.", ReaderName);
